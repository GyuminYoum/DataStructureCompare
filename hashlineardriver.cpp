...
int main()
{
   ...
   //until 100 loops,
    while(index<100)
    {
       ...
       //end
       //record collision, and time took and add to separate arrays.
       ...
       */
        ...
        */
       //random number generated and added to array
        ...
        //record searchcollision, time it took for search
   ...
   //while it loops 100
    while(index<100)
    {
       ...
       auto end = chrono::steady_clock::now();
       //end measuring
       //record #of collisions and time for insert B
       ...
       //random numbers in array
        ...
        //record # of collision during it, and time
    ...
    */
    ...
    //export data.
    read_out.open("linear_result.csv");
    for (int i=0; i<100; i++)
    {
        read_out << insertA[i] << ",";
    }
