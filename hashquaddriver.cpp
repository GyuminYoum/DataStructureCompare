...
int main()
{
   ...
   //while loop 100times
    while(index<100)
    {
       ...
       //end timing.
       //record collision, record time for insertion
       ...
       */
       ...
       //random numbers
        ...
        //end timing for search
        //record # of collisions and time
   ...
   //while looping through 100 times
    while(index<100)
    {
        //reset variables
       ...
       auto end = chrono::steady_clock::now();
       //end timing
       //record # of collisions and time for insertB
       ...
       //random numbers
        ...
        //end
        //record # of collisions and time for search B
    ...
    */
    ...
    read_out.close();
        ...
        */
        /*
        node* n3=H1.searchItem(646);
        cout << "node of interest has a value of " << n3->key << endl;
        
        cout << "collision: " << H1.getNumOfCollision() << endl;
   ...
   hash1.printTable();
   cout << "collision: " << hash1.getNumOfCollision() << endl;
   */

    /*
    Hashlinear hash1(40010);
    for(int i=0; i<20005; i++)
    {
        hash1.insertItem(i);
    }
    hash1.insertItem(40012);
    hash1.insertItem(80022);

    hash1.printTable();
    cout << "collision: " << hash1.getNumOfCollision() << endl;
    node* n1=hash1.searchItem(40012);
    ...
    */
    ...
    for (int i=0; i<11; i++)
    {
        hash3.insertItem(2+(i*i));
    }
    hash3.insertItem(4);
    hash3.insertItem(105);
    hash3.printTable();
    cout << "4 hopped " << hash3.gethop(4) << endl;
    cout << "105 hopped " << hash3.gethop(105) << endl;
